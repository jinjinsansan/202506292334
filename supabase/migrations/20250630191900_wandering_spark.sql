...
BEGIN
  ...
  IF existing_entry_id IS NOT NULL THEN
    ...
    SET 
      self_esteem_score = COALESCE(NEW.self_esteem_score, diary_entries.self_esteem_score),
      worthlessness_score = COALESCE(NEW.worthlessness_score, diary_entries.worthlessness_score),
